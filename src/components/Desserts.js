                 ...
                 Desserts.map(dessert => 
                        <div className="menu-body menu-left menu-white" key={dessert.id}> 
                            ...
                            <div className="menu-details"> 
                                ...
                                <button type="button" className="btn btn-danger" onClick={()=>{this.addDessert(dessert)}}><i className="fa fa-cart-plus fa-3"></i>Add</button>
                                <a type="button" onClick={(e)=>this.goToMenu(e,dessert.id)} className="btn btn-success"><i className="fa fa-eye fa-3" aria-hidden="true"></i>Read More</a>
                            </div>
                        </div>
            )}
            </React.Fragment>
